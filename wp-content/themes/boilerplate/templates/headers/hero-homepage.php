...
$hero_title = get_sub_field('hero_homepage_header');
$hero_content = get_sub_field('hero_homepage_text');

$hero_image = get_sub_field('hero_homepage_image');

$hero_cta_link = get_sub_field('hero_homepage_cta');
...
<div class="homepage-hero">
  ...
  <div class="image-media">
    ...
    <?php if ($hero_image['url']) : ?>
      <?php $file_ext = strtolower(pathinfo($hero_image['url'], PATHINFO_EXTENSION)); ?>
      <?php if (in_array($file_ext, ['mp4', 'webm', 'ogg'])) : ?>
        <video autoplay muted loop>
          <source src="<?php echo esc_url($hero_image['url']); ?>" type="video/<?php echo $file_ext; ?>">
        </video>
      <?php else : ?>
        <img loading="eager" src="<?php echo esc_url($hero_image['url']); ?>" alt="<?php echo esc_attr($hero_image['alt']); ?>">
      <?php endif; ?>
    <?php endif; ?>
  </div>
  <div class="container homepage-hero-content grid">
    <div class="homepage-hero-inner">
      <h1><?php echo $hero_title; ?></h1>
      <?php echo $hero_content; ?>
      <?php if ($hero_cta_link): ?>
        <a class="btn ticket purple" href="<?php echo esc_url($hero_cta_link['url']); ?>">
          <span class="ticket__label"><?php echo esc_html($hero_cta_link['title']); ?></span>
