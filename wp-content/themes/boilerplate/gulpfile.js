...
const paths = {
  ...
  images: "./src/images/**/*.{png,jpg,jpeg,gif,svg,webp}", // All image files
  imagesOutput: "./dist/images", // Destination folder for optimized images
};
...
function watchFiles() {
  ...
  gulp.watch(paths.images, optimizeImages); // Watch image files and optimize on changes
}

// Define default task
const defaultTask = gulp.series(
  gulp.parallel(compileSCSS, compileAdminSCSS, minifyJS, optimizeImages),
  watchFiles,
);
